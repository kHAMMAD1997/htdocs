...
if ($requestMethod== "POST") {
    ...
    $query = "INSERT INTO concept_note_revise_comment (concept_note_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE concept_note_revise_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM concept_note_revise_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM concept_note_revise_comment WHERE 1=1";
    $params = [];
