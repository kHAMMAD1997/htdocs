...
if ($requestMethod === 'GET') {
    ...
    if (isset($params['count_status']) && $params['count_status'] == 'true') {
        ...
        // Return the counts for all records
    ...
    elseif (isset($params['count_status_per_form'])) {
        ...
        // Count of each status type for the specified form_name
        ...
        // Return the counts for the specific form_name
        jsonResponse('success', 'Status counts retrieved successfully for form: ' . $formName, $statusCounts);
    }

    // Fetch by primary_contact_email, form_status_id, or form_name (without status counts)
