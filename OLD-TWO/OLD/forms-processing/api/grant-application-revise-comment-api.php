...
if ($requestMethod === "POST") {
    ...
    $query = "INSERT INTO grant_application_revise_comment (grant_application_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE grant_application_revise_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM grant_application_revise_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM grant_application_revise_comment WHERE 1=1";
    $params = [];
