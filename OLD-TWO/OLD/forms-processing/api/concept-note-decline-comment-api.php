...
if ($requestMethod === "POST") {
    ...
    $query = "INSERT INTO concept_note_decline_comment (concept_note_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE concept_note_decline_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM concept_note_decline_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM concept_note_decline_comment WHERE 1=1";
    $params = [];
