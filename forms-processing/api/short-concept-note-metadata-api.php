...
function handleGet($conn) {
    $sql = "SELECT * FROM short_concept_note_metadata WHERE 1=1";
    $params = [];
...
function handlePost($conn) {
    ...
    $sql = "INSERT INTO short_concept_note_metadata (concept_note_id, approve, revise, finance, declined) 
...
function handlePatch($conn) {
    ...
    $sql = "UPDATE short_concept_note_metadata SET " . implode(", ", $updates) . " WHERE metadata_id = :metadata_id";
    $stmt = $conn->prepare($sql);
...
function handleDelete($conn) {
    ...
    $sql = "DELETE FROM short_concept_note_metadata WHERE metadata_id = :metadata_id";
    $stmt = $conn->prepare($sql);
