...
if ($requestMethod === "POST") {
    ...
    $query = "INSERT INTO concept_narrative_report_revise_comment (report_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE concept_narrative_report_revise_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM concept_narrative_report_revise_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM concept_narrative_report_revise_comment WHERE 1=1";
    $params = [];
