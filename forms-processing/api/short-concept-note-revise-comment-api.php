...
if ($requestMethod === "POST") {
    ...
    $query = "INSERT INTO short_concept_note_revise_comment (concept_note_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE short_concept_note_revise_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM short_concept_note_revise_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM short_concept_note_revise_comment WHERE 1=1";
    $params = [];
