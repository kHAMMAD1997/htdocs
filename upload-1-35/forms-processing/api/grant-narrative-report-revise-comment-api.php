...
if ($requestMethod== "POST") {
    ...
    $query = "INSERT INTO grant_narrative_report_revise_comment (report_id, comment, submission_date, author_id)
    ...
    $query = "UPDATE grant_narrative_report_revise_comment 
    ...
    $stmt = $conn->prepare("DELETE FROM grant_narrative_report_revise_comment WHERE comment_id = :comment_id");
    ...
    $query = "SELECT * FROM grant_narrative_report_revise_comment WHERE 1=1";
    $params = [];
